...
import { BpmnGatewayEventbasedIcon } from '@/icons/gateway-eventbased';
...
const GatewayEventbased = (props: NodeProps<TaskType>) => {
...
export default GatewayEventbased